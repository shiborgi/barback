...
container_name="${GATEPATROL_VALKEY_CONTAINER:-gatepatrol-valkey}"
image="${GATEPATROL_VALKEY_IMAGE:-valkey/valkey:8-alpine}"
host="${GATEPATROL_VALKEY_HOST:-127.0.0.1}"
port="${GATEPATROL_VALKEY_PORT:-6379}"
volume="${GATEPATROL_VALKEY_VOLUME:-gatepatrol-valkey-data}"
